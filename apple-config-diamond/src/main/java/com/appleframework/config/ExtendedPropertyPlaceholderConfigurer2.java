...
public class ExtendedPropertyPlaceholderConfigurer2 extends PropertyPlaceholderConfigurer {
	
	private static Logger logger = Logger.getLogger(ExtendedPropertyPlaceholderConfigurer2.class);
